...
#ifndef S500_ROS2_DRIVER_MESSAGE_PING_MESSAGE_COMMON_HPP
#define S500_ROS2_DRIVER_MESSAGE_PING_MESSAGE_COMMON_HPP
...
public:
    ...
    common_ack(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    common_nack(uint8_t* buf,
uint16_t nack_message_length) : ping_message { buf, static_cast<uint16_t>(12 + nack_message_length) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    common_ascii_text(uint8_t* buf,
uint16_t ascii_message_length) : ping_message { buf, static_cast<uint16_t>(10 + ascii_message_length) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    common_general_request(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    common_device_information(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(16) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
    ...
    int getMessageAsString(char* string, size_t size) const {
        ...
        if (written > 0 && written < static_cast<int>(size)) {
            return snprintf(string + written, size - static_cast<size_t>(written),
                "  device_type:  %" PRIu8 "\n"
                "  device_revision:  %" PRIu8 "\n"
                "  firmware_version_major:  %" PRIu8 "\n"
                "  firmware_version_minor:  %" PRIu8 "\n"
                "  firmware_version_patch:  %" PRIu8 "\n"
                "  reserved:  %" PRIu8 "\n"
                , device_type()
                , device_revision()
...
public:
    ...
    common_protocol_version(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(14) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    common_set_device_id(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(11) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
#endif // S500_ROS2_DRIVER_MESSAGE_PING_MESSAGE_COMMON_HPP
