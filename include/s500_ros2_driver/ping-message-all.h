...
public:
    ...
    static constexpr const char* nameFromMessageId(const PingEnumNamespace::PingMessageId messageId) {
        ...
        case PingEnumNamespace::PingMessageId::PING1D_SET_OSS_PROFILE_CONFIGURATION:
            return "SET_OSS_PROFILE_CONFIGURATION";
        ...
        case PingEnumNamespace::PingMessageId::PING1D_OSS_PROFILE_CONFIGURATION:
            return "OSS_PROFILE_CONFIGURATION";
        ...
        case PingEnumNamespace::PingMessageId::S500_SET_PING_PARAMS:
            return "SET_PING_PARAMS";
        ...
        case PingEnumNamespace::PingMessageId::S500_DISTANCE2:
            return "DISTANCE2";
        ...
        case PingEnumNamespace::PingMessageId::S500_PROFILE6_T:
            return "PROFILE6_T";
